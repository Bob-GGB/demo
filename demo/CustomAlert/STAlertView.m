...
- (instancetype)initWithTitle:(NSString *)title image:(UIImage *)image message:(NSString *)message buttonTitles:(NSArray *)buttonTitles{
    if (self = [self initWithFrame:CGRectZero]){
        ...
        _buttonTitles = [NSArray arrayWithArray:[buttonTitles copy]];
    }
    return self;
}
...
- (void)loadUI{
    ...
    _backgroundView.layer.shadowColor = [UIColor colorWithWhite:0 alpha:0.2].CGColor;
...
- (void)addLine:(CGRect)frame toView:(UIView *)view{
    ...
    line.backgroundColor = [UIColor colorWithRed:0.86 green:0.86 blue:0.87 alpha:1];
...
- (void)loadMessage{
    ...
    if (!_messageLabel){
        ...
        _messageLabel.textColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1];
...
- (UIButton *)addButton:(CGRect)frame title:(NSString *)title tag:(NSInteger)tag{
    ...
    [button setBackgroundImage:st_imageWithColor([UIColor whiteColor]) forState:UIControlStateNormal];
    [button setBackgroundImage:st_imageWithColor([UIColor whiteColor]) forState:UIControlStateHighlighted];
